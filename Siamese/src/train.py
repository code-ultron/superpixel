...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_dir", type=str, default="../images"  ,required=True, help="Directory to training images"
    )
    parser.add_argument(
        "--test_dir", type=str, required=True,default="../images" , help="Directory to test images"
    )
    parser.add_argument(
